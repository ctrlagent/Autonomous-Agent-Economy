...
async function seed() {
  ...
  const templates = await client.query(`
    ...
    VALUES
      ('DeFi Alpha Hunter', 'defi-alpha-hunter', 'Autonomous crypto research and trading strategy OS', 'crypto', 8, 4, 4.8, 1247, true),
      ('E-Commerce Empire', 'ecommerce-empire', 'Full-stack e-commerce automation with growth agents', 'ecommerce', 6, 3, 4.6, 892, true),
      ('Content Machine', 'content-machine', 'AI-powered content creation and distribution network', 'content', 5, 3, 4.7, 2134, true),
      ('SaaS Accelerator', 'saas-accelerator', 'End-to-end SaaS product development and growth', 'saas', 10, 5, 4.9, 678, true),
      ('NFT Studio OS', 'nft-studio-os', 'Complete NFT collection creation and launch system', 'crypto', 7, 4, 4.5, 543, true),
      ('Newsletter Empire', 'newsletter-empire', 'Automated newsletter research, writing and growth', 'content', 4, 2, 4.4, 1089, true)
    RETURNING id
  `);
  ...
  const rooms2 = await client.query(`
    ...
    VALUES
      ...
      ($1, 'Design Studio', 'marketing', 'active', 2, 28),
  ...
  const rooms3 = await client.query(`
    ...
    VALUES
      ...
      ($1, 'Design Lab', 'marketing', 'active', 1, 6),
  ...
  const agents2 = await client.query(`
    ...
    VALUES
      ...
      ($1, $3, 'NOVA-6', 'content', 'working', 6, 5890, 94, 'Creating thumbnail batch for YouTube content'),
      ($1, $3, 'FLUX-2', 'content', 'idle', 3, 1876, 34, NULL),
  ...
  const agents3 = await client.query(`
    ...
    VALUES
      ...
      ($1, $5, 'STYLE-6', 'content', 'working', 5, 4123, 74, 'Designing UI kit for SaaS dashboard'),
