...
function FloatingEvents() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      setEvents((prev) => [
        ...prev.slice(-3),
        { id: Date.now(), text: ev.text, color: ev.color },
      ]);
    };
    tick();
        ...
        <div style={{ flexShrink: 0, width: "min(520px,44%)" }}>
          ...
          >
            ...
            >
              ...
              crews operating inside living digital stations.
            </p>
            <div
              style={{
                display: "flex",
  ...
  return (
    ...
    >
      ...
      >
        <SectionHeader
          label="LIVE PREVIEW"
          title="Your Station at a Glance"
          sub="Every station is a living economy — six specialized rooms, each running autonomous agents around the clock."
        />
        <div
          style={{
            display: "grid",
        ...
        >
                ...
                >
                  ...
                  >
                    <span style={{ ...mono, fontSize: 7, color: C.muted }}>
                      AGENTS: <span style={{ color }}>{room.agents}</span>
                    </span>
                    <span style={{ ...mono, fontSize: 7, color: C.muted }}>
                      TASKS: <span style={{ color }}>{room.tasks}</span>
                    </span>
                  </div>
                  <div style={{ height: 3, background: C.border }}>
                    <motion.div
                      initial={{ width: 0 }}
                      animate={inView ? { width: `${room.progress}%` } : {}}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <StatCard
              label="TASKS TODAY"
              value={String(summary?.tasksCompletedToday ?? 6)}
              color={C.amber}
            />
            <StatCard
              label="OVERALL PROGRESS"
              value={`${Math.round(summary?.overallProgress ?? 55.4)}%`}
              color={C.violet}
            />
            ...
            >
              ...
              >
                {[
                  40, 55, 48, 72, 88, 76, 92, 84, 96, 88, 100, 94, 108, 116,
                  102, 120, 112, 128, 118, 136, 124, 142, 132, 148,
                ].map((v, i) => (
                  <motion.div
                    key={i}
                    initial={{ height: 0 }}
                    animate={inView ? { height: `${(v / 150) * 48}px` } : {}}
                    transition={{ delay: i * 0.02, duration: 0.5 }}
                    style={{
                      flex: 1,
                      background: `${C.green}${Math.round((v / 150) * 99 + 30).toString(16)}`,
                      minWidth: 2,
                    }}
                  />
                ))}
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 10 }}>
        <div style={{ padding: "0 60px" }}>
          <SectionHeader
            label="CREW SYSTEM"
            title="Your Autonomous Agent Army"
            sub="Specialized AI agents, each with defined roles, unique skills, and persistent memory — working 24/7 inside your stations."
          />
        </div>
        ...
        >
          ...
          <div
            style={{
              ...
              color: C.cyan,
              textShadow: `0 0 60px ${C.cyan}, 0 0 120px ${C.cyan}44`,
            }}
          >
            {displayAgents.length > 0
              ? `${displayAgents.filter((a) => a.status === "working").length} AGENTS`
              : "19 AGENTS"}
          </div>
          <div
            style={{
          ...
          {doubled.map((agent, i) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ ...mono, fontSize: 6, color: C.muted }}>
                  LV.{agent.level} • {agent.experience % 100}% XP
                </div>
                <motion.div
                  animate={{ opacity: [0.6, 1, 0.6] }}
...
const COMMS_MESSAGES = [
  {
    from: "NEXUS-1",
    role: "strategy",
    text: "Commander, deep scan of sector 4 complete. No threats detected.",
  },
  {
    from: "FORGE-3",
    role: "builder",
    text: "Build pipeline deployed. 3 new endpoints live and passing all tests.",
  },
  {
    from: "GROW-4",
    role: "growth",
    text: "Viral loop coefficient at 1.34. Revenue trajectory optimal.",
  },
  {
    from: "VECTOR-9",
    role: "research",
    text: "Alpha signal detected — large wallet accumulating PENDLE.",
  },
  {
    from: "ECHO-1",
    role: "content",
    text: "22-tweet thread on restaking mechanics live — 4.2K impressions.",
  },
  {
    from: "LENS-9",
    role: "analytics",
    text: "Q1 report complete. KPIs all within green thresholds.",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        <SectionHeader
          label="SHIP COMMS"
          title="AI Crew Communications"
          sub="Every agent reports directly to Command. Watch your autonomous crew coordinate in real time across all channels."
        />
        <div
          style={{
            display: "grid",
        ...
        >
          {/* Channels sidebar */}
          <div
            style={{ borderRight: `1px solid ${C.border}`, padding: "16px 0" }}
          >
            <div
              style={{
                ...mono,
            ...
            {[
              { label: "#all-crew", active: true },
              { label: "#research", active: false },
              { label: "#builders", active: false },
              ...
              <div
                ...
                style={{
                  ...
                  fontSize: 8,
                  padding: "8px 14px",
                  color: ch.active ? C.cyan : C.muted,
                  background: ch.active ? `${C.cyan}12` : "transparent",
                  borderLeft: ch.active
                    ? `2px solid ${C.cyan}`
              ...
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <span
                        style={{ ...px, fontSize: 7, color: roleHex(msg.role) }}
                      >
                        {msg.from}
                      </span>
                      <span style={{ ...mono, fontSize: 6, color: C.muted }}>
              ...
              <div key={r.role} style={{ marginBottom: 10 }}>
                ...
                <div style={{ height: 3, background: C.border }}>
                  <motion.div
                    ...
                    style={{
                      height: "100%",
                      background: roleHex(r.role),
                      boxShadow: `0 0 6px ${roleHex(r.role)}`,
                    }}
                  />
                </div>
              </div>
...
const MISSIONS = [
  {
    title: "Reach $5,000 Revenue",
    desc: "Drive autonomous revenue to the next tier",
    progress: 77,
    target: "$5,000",
    current: "$3,840",
    xp: 500,
  ...
  {
    title: "Launch 10 Products",
    desc: "Ship products across all builder nodes",
    progress: 70,
    target: "10",
    current: "7",
    xp: 300,
  ...
  {
    title: "Get 1,000 Users",
    desc: "Expand your user base through growth loops",
    progress: 34,
    target: "1000",
    current: "342",
    xp: 400,
  ...
  },
  {
    ...
    desc: "Deploy smart contracts to production",
    progress: 0,
    target: "3",
    current: "0",
    xp: 250,
  ...
  {
    title: "Reach 90% Agent Perf.",
    desc: "Optimize crew for peak performance",
    progress: 0,
    target: "90%",
    current: "—",
    xp: 600,
    ...
    >
      ...
      >
        <SectionHeader
          ...
          title="Progress. Reward. Scale."
          sub="Missions are the engine of your station economy. Complete objectives to unlock higher-tier capabilities and reward your crew."
        />
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {MISSIONS.map((m, i) => (
            ...
            >
                  ...
                  <>
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          height: "100%",
                          background: `linear-gradient(to right, ${m.color}88, ${m.color})`,
                          boxShadow: `0 0 8px ${m.color}`,
                        }}
                      />
                    </div>
                    <div style={{ ...mono, fontSize: 7, color: C.muted }}>
                      {m.current} / {m.target} — {m.progress}%
                    </div>
                  </>
                )}
              </div>
              ...
              >
                <div style={{ ...px, fontSize: 9, color: m.color }}>
                  +{m.xp}
                </div>
  ...
  return (
    ...
    >
      ...
      >
        <SectionHeader
          label="MARKETPLACE"
          title="Deploy a Station in Seconds"
          sub="Pre-built station blueprints for every business model. Choose a template, name your station, and watch your AI crew get to work."
        />
        <div
          style={{
            display: "grid",
            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", gap: 16, marginBottom: 14 }}>
                  ...
                  <span style={{ ...mono, fontSize: 7, color: C.amber }}>
                    ★ {t.rating}
                  </span>
                </div>
                <div
                  style={{ height: 1, background: C.border, marginBottom: 14 }}
                />
                <div
                  style={{
                    display: "flex",
                ...
                >
                  <span style={{ ...mono, fontSize: 7, color: C.muted }}>
                    {t.usageCount?.toLocaleString()} deployed
                  </span>
                  <motion.button
  ...
  return (
    ...
    >
      ...
      >
        <SectionHeader
          label="LIVE ACTIVITY"
          title="Your Station, Live"
          sub="Every agent action, mission update, and revenue event — recorded in real time across your entire agent economy."
        />
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <span style={{ ...px, fontSize: 7, color }}>
                      {item.agentName}
                    </span>
                    <span style={{ ...mono, fontSize: 7, color: C.muted }}>
    ...
    >
      ...
      >
        <SectionHeader
          ...
          sub="A full-stack autonomous agent platform — from pixel dungeon simulation to live API infrastructure."
        />
        <div
          style={{
            display: "grid",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          height: 600,
          borderRadius: "50%",
          background: `radial-gradient(ellipse, ${C.cyan}15 0%, transparent 70%)`,
          pointerEvents: "none",
        }}
      />
      <div
        ...
        >
          ...
          >
            <svg width="80" height="80" viewBox="0 0 80 80">
              ...
              />
              <polygon
                points="40,18 60,29 60,51 40,62 20,51 20,29"
                fill="none"
                stroke={C.cyan}
                strokeWidth="0.8"
                opacity="0.4"
          ...
          >
            The operating system for autonomous AI civilizations.
            <br />
