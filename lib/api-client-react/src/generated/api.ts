 ...
 */
export const getDeleteRoomUrl = (id: number, roomId: number) => {
  return `/api/stations/${id}/rooms/${roomId}`;
};
...
export const deleteRoom = async (
  ...
  return customFetch<void>(getDeleteRoomUrl(id, roomId), {
    ...options,
    method: "DELETE",
  });
};
...
> => {
  ...
  > = (props) => {
    ...
    return deleteRoom(id, roomId, requestOptions);
  };
 ...
 */
export const getCreateAgentUrl = (id: number) => {
  return `/api/stations/${id}/agents`;
};
...
export const createAgent = async (
  ...
  return customFetch<Agent>(getCreateAgentUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
> => {
  ...
  > = (props) => {
    ...
    return createAgent(id, data, requestOptions);
  };
